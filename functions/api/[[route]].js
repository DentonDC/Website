import { canInvite, canManageMoney, canPublish, codeHint, getSessionUser, hashCode, isRole, makeCode, requireRole, requireUser } from "../_lib/auth.js";
import { ensureSchema, logAction, newId, nowIso, publicUser, rublesToCents } from "../_lib/db.js";
import { clearCookie, cookieHeader, errorResponse, HttpError, json, readBody } from "../_lib/http.js";
...
export async function onRequest(context) {
  ...
  try {
    ...
    const response = await route(env, request, parts, key, body, url);
    return response;
  } catch (error) {
